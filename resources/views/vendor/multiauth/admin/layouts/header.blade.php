        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active treeview menu-open">
                <li>
                    <a href="">
                      <i class="fa fa-shopping-cart"></i> <span>MarketPlace Settings</span>
           ...
           <li class="treeview">
              ...
              <ul class="treeview-menu">
              <li><a href="{{route('admin.products')}}"><i class="fa fa-circle-o"></i> All Products</a></li>
               <li><a href="{{route('add.products')}}"><i class="fa fa-circle-o"></i> Add Products</a></li>
                <li><a href=""><i class="fa fa-circle-o"></i> Group Products</a></li>
                <li><a href=""><i class="fa fa-circle-o"></i> Virtual Products</a></li>
