                      ...
                      <form  action="{{route('profile.update')}}" class="form-horizontal" method="post">
                        {{csrf_field()}}
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <input type="name" name="name" value="{{$name}}" class="form-control" id="inputName" placeholder="Name">
                            </div>
                          </div>
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                    <input type="password" name="password" value="{{$password}}" class="form-control" id="inputEmail" placeholder="Email">
                                  </div>
                          </div>
                         {{-- <div class="form-group">
